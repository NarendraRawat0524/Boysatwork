      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-16 text-center">
          <div className="bg-muted/50 rounded-2xl p-8 max-w-3xl mx-auto">
            <h2 className="text-xl font-heading font-extrabold mb-2">Can't find what you're looking for?</h2>
            <p className="text-muted-foreground mb-4">
              We offer many more services. Contact us to discuss your specific requirements.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <a href="tel:9811797407" className="font-semibold underline hover:opacity-80 transition-opacity">
                Call: +91 9811797407
              </a>
              <span className="text-muted-foreground">|</span>
              <a href="mailto:shivskukreja@gmail.com" className="font-semibold underline hover:opacity-80 transition-opacity">
